...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/icons/fontawesome/styles.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/icons/icomoon/styles.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/icons/fontawesome/styles.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/jquery.fancybox.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/owl.carousel.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/jquery.mCustomScrollbar.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/indicator.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/counter.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/contacts.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/loader.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/app.css') }}" />

    <script src="https://code.jquery.com/jquery-3.6.3.js" integrity="sha256-nQLuAZGRRcILA+6dMBOvcRh5Pe310sBpanc6+QBmyVM=" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
    <script src="https://yastatic.net/share2/share.js"></script>
    <script type="text/javascript" src="{{ secure_asset('js/jquery.maskedinput.js') }}"></script>
    <script type="text/javascript" src="{{ secure_asset('js/jquery.fancybox.min.js') }}"></script>
    <script type="text/javascript" src="{{ secure_asset('js/owl.carousel.min.js') }}"></script>
    <script type="text/javascript" src="{{ secure_asset('js/jquery.mCustomScrollbar.concat.min.js') }}"></script>
    <script type="text/javascript" src="{{ secure_asset('js/indicators.js') }}"></script>
    <script type="text/javascript" src="{{ secure_asset('js/fancybox_init.js') }}"></script>
    <script type="text/javascript" src="{{ secure_asset('js/owl_settings.js') }}"></script>
    <script type="text/javascript" src="{{ secure_asset('js/max.height.js') }}"></script>
    <script type="text/javascript" src="{{ secure_asset('js/main.js') }}"></script>
    <script type="text/javascript" src="{{ secure_asset('js/loader.js') }}"></script>
    <script type="text/javascript" src="{{ secure_asset('js/feedback.js') }}"></script>
</head>
    ...
    <div class="brands">
        @foreach ($electedBrands as $brand)
            <div class="brand-logo" style="width:{{ round(100/count($electedBrands)) }}%;">
                <a href="#" class="brand" brand="{{ $brand->slug }}"><img class="w-75" title="{{ $brand->ru }}" src="{{ secure_asset($brand->logo) }}" /></a>
            </div>
        @endforeach
    </div>
...
<div id="logo-line">
    <div class="container">
        <div class="logo-block">
            <div class="logo"><a href="{{ route('home') }}"><img class="w-100" src="{{ secure_asset('storage/images/logo.svg') }}" /></a></div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 d-none d-lg-block p-0">
                <a href="{{ route('contacts') }}"><img class="w-100 border border-5 border-white" src="{{ secure_asset('storage/images/apollomotors.jpg') }}" /></a>
            </div>
            ...
            <div class="col-lg-{{ $blockContent ? 2 : 3 }} col-xs-12 d-lg-block p-0 text-center">
                <img class="w-50 d-lg-inline-flex d-none" src="{{ secure_asset('storage/images/logo_white.svg') }}" />
...
{{--                    </a>--}}
            ...
            @endif
            <p class="fs-7 text-center mt-1"><a href="{{ secure_asset('storage/requisites.pdf') }}" target="_blank">{{ trans('content.our_details') }}</a></p>
        </div>
    </div>
</footer>
